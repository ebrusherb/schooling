...
title(strcat('Resident = ',num2str(strats(1)),', Invader = ',num2str(invaderstrats(1))));
...
yl=get(c,'YLabel');
set(yl,'String','Probability of being eaten','Rotation',270,'Position',[8 .37 1.001]);
xlabel('Number of informed neighbors')
ylabel('Number of informed birds in the flock')
title(strcat('Resident = ',num2str(strats(2)),', Invader = ',num2str(invaderstrats(2))));
