...
%         parfor ind=1:5
            ...
            [probeaten, probgettoeat, both]=signalingevents_new(strategy,numsigs_permove,nummoves,radius,b,T);
...
filename=strcat('/home/brush/schooling_consensus/ESS_3regimes_','_nummoves=',num2str(nummoves),'_numpermove=',num2str(numsigs_permove),'.mat');
save(filename,'strats','radvals','Tvals','storefitnesseaten','storerhoeaten','ESSseaten','storefitnessgettoeat','storerhogettoeat','ESSsgettoeat','storefitnessboth','storerhoboth','ESSsboth');
